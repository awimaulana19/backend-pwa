<section id="registrasi">
    <div class="row">
        <div class="col-12">
            ...
            <p class="subtitle">Kunjungan Ulang Kehamilan</p>
        </div>
    </div>

    <div class="row mt-4">
        <div class="col-12">
            <form id="form_pemeriksaanulang">
                @csrf
...
<script>
    $('#form_pemeriksaanulang').submit(function(event) {
        event.preventDefault();

        $.ajax({
            url: '{{ route('kunjunganulang_store') }}', // Ganti dengan URL yang sesuai untuk menyimpan data ke dalam database
            type: 'POST',
            data: $(this).serialize(),
