@extends('User.Layouts.app', ['title' => 'Pendaftaran Pemeriksaan Awal'])
...
@section('content')
    <section id="registrasi">
        ...
        <div class="row mt-4">
            <div class="col-12">
                <form action="{{ route('pemeriksaanawal.store') }}" method="POST">
                    @csrf
                    <input type="text" name="user_id" value="{{ auth()->user()->id }}" hidden>
                    <input type="text" name="periksa" value="Pemeriksaan Awal" hidden>
                    <div class="mb-3">
